...
export function RoadmapExplorer({
  ...
  /** Aulas do cronograma dinâmico do aluno. Usado pela Trilha Formação (visão de roadmap
      ...
      {track === "FORMACAO" ? (
        <>
          <p className="text-sm text-muted-foreground">
            Sua trilha de aprendizado, módulo por módulo — inspirada em{" "}
            <span className="font-medium">roadmap.sh</span>. Cada módulo mostra seu progresso real
            a partir do{" "}
        ...
        <>
          {track === "PRODUTO" ? (
            <p className="text-sm text-muted-foreground">
              Evolução do produto &ldquo;APEX Academy&rdquo; (o SaaS construído pelo aluno ao
              longo da formação) — distinto da AI Labs. Semanas sem marco definido aparecem como
              &ldquo;a definir&rdquo;.
            </p>
          ) : (
            <p className="text-sm text-muted-foreground">
              Habilidades de mercado e carreira trabalhadas ao longo da formação (comunicação com
              cliente, documentação, code review, portfólio, entrevista técnica, e mais). Semanas
              sem marco definido aparecem como &ldquo;a definir&rdquo;.
            </p>
          )}
